...
job('EPBYMINW3088/MNTLAB-aaksionkin-DSL-build-job') {
    ...
    parameters {
        ...
        runParam(' ','EPBYMINW3088/MNTLAB-aksionkin-child1-build-job',' ', 'ALL')
        runParam(' ','EPBYMINW3088/MNTLAB-aksionkin-child2-build-job',' ', 'ALL')
        runParam(' ','EPBYMINW3088/MNTLAB-aksionkin-child3-build-job',' ', 'ALL')
        runParam(' ','EPBYMINW3088/MNTLAB-aksionkin-child4-build-job',' ', 'ALL')
